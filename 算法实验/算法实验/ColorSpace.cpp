...
//void rgb2lab( float R, float G, float B, float & l_s, float &a_s, float &b_s )
{
    ...
    float var_X = X / 95.047 ;    //ref_X =  95.047   Observer= 2¡ã, Illuminant= D65
...
//void lab2rgb( float l_s, float a_s, float b_s, float& R, float& G, float& B )
{
    ...
    float X = 95.047 * var_X ;    //ref_X =  95.047     Observer= 2¡ã, Illuminant= D65
    float Y = 100.000 * var_Y  ;   //ref_Y = 100.000
    float Z = 108.883 * var_Z ;    //ref_Z = 108.883


    var_X = X / 100. ;       //X from 0 to  95.047      (Observer = 2¡ã, Illuminant = D65)
